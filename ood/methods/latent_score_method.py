...
They get the latent representation of the data and then compute the lp-norm of the latent representation.
For p = 2, this would give us something the same as the likelihood error.
However, we believe that for every p in-distribution data should have a lower lp-norm than out-of-distribution data.
Therefore, we expect for p > 2 that the lp-norm of in-distribution data is lower than the lp-norm of out-of-distribution data.
"""
import typing as th
import torch
